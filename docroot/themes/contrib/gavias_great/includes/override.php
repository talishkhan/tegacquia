<?php
function gavias_great_preprocess_views_view_list(&$variables){
   //$variables['title_prefix'] = '';
   //$variables['title_suffix'] = '';
   //print_r($variables['title_prefix']); die();
}

function gavias_great_preprocess_views_view_unformatted__taxonomy_term(&$variables){
...
function gavias_great_preprocess_views_view_unformatted(&$variables) {
   $variables['title_prefix'] = '';
   $variables['title_suffix'] = '';
   $view = $variables['view'];
   $rows = $variables['rows'];
...
function gavias_great_preprocess_username(&$variables){
...
function gavias_great_preprocess_views_view_grid(&$variables) {
   $view = $variables['view'];
   $rows = $variables['rows'];
   $style = $view->style_plugin;
   $options = $style->options;
